            ...
            <form id="editdata">
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="tgl" name="tempat_lahir" value="<?= $user[0]['tempat_lahir'] ?>" placeholder="Tempat Lahir Belum Ditambahkan" required>
                    </div>
                    <div class="form-group col-md-4">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input list="jurusan" class="form-control" name="jurusan" value="<?= $user[0]['jurusan'] == null ? null : $user[0]['jurusan']  ?>" placeholder="Jurusan Belum Di Tambahkan" required>
                        <datalist id="jurusan">
