            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card card-body shadow">
                        <a href="<?= base_url() ?>/img/cv/<?= $user[0]['cv'] ?>" data-title="Foto Curriculum Vitae" data-max-height="400" data-toggle="lightbox">
                            <img class="img-fluid px-3 px-sm-4 mt-3 mb-4 col-md-3 offset-md-4" width="200px" src="<?= base_url() ?>/img/cv/<?= $user[0]['cv'] ?>">
                        </a>
