                ...
                <div class="col-md-8 mb-4">
                    <div class="card card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="nik" value="<?= $user[0]['nik'] == null ? 'NIK Belum Ditambahkan' :  $user[0]['nik'] ?>" disabled>
                        </div>
                        <div class="form-group">
                        ...
                        <a class="btn btn-sm btn-success form-control mt-2" href="upload_ktpkk.php">Upload KTP dan Kartu Keluarga</a>
                    </div>
                </div>
            </div>
